...
const MovieDetails = () => {
  ...
  return show ? (
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      <div className="flex flex-col flex-wrap md:flex-row gap-8 max-w-6xl mx-auto">
        <img
        ...
        {/* Adding Watch trailer and buy ticket button */}
      ...
      {/* Code for recommended movies for user (you may also like) */}
